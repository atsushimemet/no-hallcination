    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white px-4 py-8">
        ...
        <p className="text-blue-100 mb-4">
          AIに回答してもらい、みんなでハルシネーションをなくしましょう
        </p>
      ...
      <Tabs defaultValue="all" className="px-4 pt-4">
        ...
        <TabsContent value="active" className="space-y-3 mt-4">
          {posts
            .filter((p) => p.status === "active" || p.status === "disputed")
            .map((post) => (
              <PostCard key={post.id} post={post} />
            ))}
        </TabsContent>
          ...
          <div className="flex-1">
            ...
            {post.conclusion && (
              <div className="bg-slate-50 rounded-lg p-2 mb-3">
                <div className="flex items-center gap-1 mb-1">
                  ...
                  <Badge
                    className={`${evidenceLevel.color} text-white text-xs ml-auto`}
                  >
                    {evidenceLevel.label}
                  </Badge>
                </div>
            ...
            <div className="flex items-center gap-4 text-xs text-slate-500">
              ...
              <div className="flex items-center gap-1">
                ...
                <span>
                  {post.arguments.reduce((sum, arg) => sum + arg.votes, 0)}
                </span>
              </div>
              <div className="flex items-center gap-1">
